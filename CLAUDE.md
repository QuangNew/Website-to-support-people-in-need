...
This project is indexed by GitNexus as **Website-to-support-people-in-need** (2253 symbols, 6509 relationships, 94 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
