...
This project is indexed by GitNexus as **Website-to-support-people-in-need** (2424 symbols, 6979 relationships, 105 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
